...
@section('content')
  ...
  <div class="bg-gray-100 flex-1 p-6 md:mt-16"> 
    ...
    <!-- General Report -->
    <div class="grid grid-cols-4 gap-4 xl:grid-cols-1">
    ...
    <div class="card bg-teal-400 border-teal-400 shadow-md text-white">
        <div class="card-body flex flex-row">
            ...
            <div class="py-2 ml-10 text-4xl font-medium leading-tight text-gray-800">
                ...
                Anda login Sebagai 
                <span class="inline-block py-1.5 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-blue-600 text-white rounded">Admin !</span>
